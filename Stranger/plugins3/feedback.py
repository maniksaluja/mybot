        ...
        if msg.media_group_id:
            ...
            await snt[0].reply_text(
                ...
                reply_markup=InlineKeyboardMarkup([
                    [InlineKeyboardButton(text="𝘚𝘩𝘢𝘳𝘦 𝘞𝘪𝘵𝘩 𝘜𝘴", url = "https://t.me/Cute_GirlTG")],
                    ])
            )
        else:
            ...
            await snt.reply_text(
                text="**Requesting Content. If Anyone Can\n Provide It, Please Share.With US**",
                reply_markup=InlineKeyboardMarkup([
                    [InlineKeyboardButton(text="𝘚𝘩𝘢𝘳𝘦 𝘞𝘪𝘵𝘩 𝘜𝘴", url = "https://t.me/CuteGirlTG")],
                    ])
            )
...
async def admin_reject(client:Client, callback_query: CallbackQuery):
    ...
    try:
        ...
        await callback_query.edit_message_text(f"**REQUEST REJECTED \n> Check Your Inbox I sended You Msg Related This Request Check this Bot Inbox** @{me.username} to send message to user")
