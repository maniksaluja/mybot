...
from strings import MB_USELESS, REPLACE_LINK_TUTORIAL
...
async def handle_useless(c: Client, msg: Message):
    ...
    await msg.reply(MB_USELESS.format(msg.from_user.mention),quote=True, disable_notification=False, reply_markup=InlineKeyboardMarkup(btn))
